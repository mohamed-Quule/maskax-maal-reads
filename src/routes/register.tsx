      ...
      <section className="mx-auto grid max-w-5xl gap-12 px-6 py-16 md:grid-cols-2 md:py-24">
        <div className="hidden md:block">
          <div className="inline-flex items-center gap-2 rounded-md bg-emerald/10 px-3 py-1 text-xs font-semibold text-emerald">
            <UserPlus className="size-3.5" /> {lang === "en" ? "Reader account" : "Akoon akhriyaha"}
          </div>
          <h1 className="mt-6 font-display text-5xl leading-tight">
            {lang === "en" ? "Join the Somali digital library." : "Ku biir maktabadda dhijitaal ee Soomaaliyeed."}
          </h1>
